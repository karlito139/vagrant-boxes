...
server {
  ...
  location ~ \.php$ {
    ...
    #Other fastcgi options will certainly ruine everything : be aware.
...
; Store the last error/warning message in  (boolean). Setting this value
...
; This directive determines whether PHP registers  &  each time it
; runs.  contains an array of all the arguments passed to PHP when a script
; is invoked.  contains an integer representing the number of arguments
...
; Most likely, you won't want to disable this option globally. It causes 
; and  to always be empty; the only way you will be able to read the
...
; Always populate the  variable. PHP's default behavior is
...
; Enable upload progress tracking in 
; Default Value: On
; Development Value: On
; Production Value: On
...
; A prefix used for the upload progress key in 
...
; The index name (concatenated with the prefix) in 
